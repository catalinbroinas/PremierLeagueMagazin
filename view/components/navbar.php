...
<!--Navbar-->
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark purple darken-4">
      ...
      <!-- Navbar brand -->
        ...
        <div class="collapse navbar-collapse" id="basicExampleNav">
            ...
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link white-text" href="<?php echo site_url() .'/view/produse.php'; ?>"><strong>Oferta completă</strong>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link white-text" href="<?php echo site_url() .'/view/nou.php'; ?>"><strong>Noutăți</strong>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link white-text" href="<?php echo site_url() .'/view/moda.php'; ?>"><strong>Modă</strong>           
                    </a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link white-text" href="<?php echo site_url() .'/view/suveniruri.php'; ?>"><strong>Suveniruri</strong>
                    </a>
                </li>
            </ul>
            <!-- Links -->
            ...
            <form class="form-inline">
                <div class="md-form my-0">
                    <input class="form-control mr-sm-2 white-text" type="text" placeholder="Caută" aria-label="Caută">
